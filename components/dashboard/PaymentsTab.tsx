            ...
            <Table className="font-sans p-[10px]">
                <TableHead className="text-[20px]">
                    <TableRow>
                        ...
                        <TableHeaderCell className="text-center">Business Number</TableHeaderCell>
                        <TableHeaderCell className="text-center">Cell Number</TableHeaderCell>
                ...
                <TableBody>
                    {tenants.map((item) => (
                        <TableRow key={item.id}>
                            ...
                            <TableCell className="text-center p-[8px]">
                                <div className="m-[10px] text-[16px] rounded-xl">
                                    {item.business_phone ? item.business_phone.replaceAll("-", " - ") : "---"}
                                </div>
                            </TableCell>
                            <TableCell className="text-center p-[8px]">
                                <div className="m-[10px] text-[16px] rounded-xl">
                                    {item.cell_phone ? item.cell_phone.replaceAll("-", " - ") : "---"}
                                </div>
                            </TableCell>
                            <TableCell className="text-center p-[8px]">
                                <div className="m-[10px] text-[16px] rounded-xl">
