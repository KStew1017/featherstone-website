...
export default function MissionStatement() {
    return (
        <section className="flex flex-col min-h-[20%] bg-tan-100">
            <div className="flex gap-[90px] justify-center sm:pt-[35px] lg:pb-[35px]">
                ...
                <Reveal hiddenVariant="hiddenY" visibleVariant="visibleY" delay={0.25}>
                    <div className="max-w-3xl text-center">
                        <p className="font-sans text-[20px] lg:text-[24px] text-grey p-5 sm:w-[90%] mx-auto sm:rounded-full bg-tan-200">
